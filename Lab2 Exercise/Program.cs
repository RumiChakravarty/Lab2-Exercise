            ...
            if( playgame == "yes")
            {
               // Console.Clear();
                ...
                if (readreply == "face the beast") 
                {
                    ...
                    {
                        case "1":
                            Console.WriteLine($"No one has ever faced {head} dragon befor! ");
                            break;
                        case "2":
                            Console.WriteLine($"No one has ever faced a {head} dragon befor! ");
                            break;
                        case "3":
                        ...
                        case "bow and arrow":
                            ...
                            switch (eye)
                                ...
                                case "red":
                                    ...
                                    Console.WriteLine(username +" and " + name +" live happily ever after");
                                    break;
                        case "blue":
